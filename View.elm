module View exposing (col, deadwoodInput, gameScore, hasPlayer, knockButton, knockButtons, playerString, roundDisplay, roundStateUI, row, scoreDisplay, singleScoreDisplay, view)
...
gameScore model =
    let
        basicDisplay =
            [ scoreDisplay "Total" model.roundTotal ]
    in
    case model.state of
        InProgress ->
            basicDisplay
